...
export const INJURIES: InjuryItem[] = [
  ...
  },
  {
    ...
    status: "ok",
    updated: "2026-08-29",
    headline: "프리드, 15일 부상자 명단서 복귀… 레드삭스전 더블헤더 선발 등판",
    summary:
      "좌측 팔꿈치 골타박상으로 8월 14일자 부상자 명단에 올랐던 프리드가 최소 이탈 기간인 15일이 지나며 활동 명단으로 복귀해요. 양키스는 8월 29일 보스턴 레드삭스와의 더블헤더 중 한 경기에 프리드를 선발로 예고했고, 나머지 한 경기는 카를로스 로돈이 맡을 예정이에요.",
  },
  {
    id: "mlb-marte-knee",
  ...
  },
  {
    ...
    status: "questionable",
    updated: "2026-08-29",
    headline: "쿠두스, 교체 출전으로 복귀 가시권… 완전 복귀는 서두르지 않는 분위기",
    summary:
      "데 제르비 감독은 쿠두스가 이번 라운드 교체 카드로 나설 수 있다고 언급하며 복귀가 가까워졌음을 시사했어요. 다만 지난 1월 재발한 허벅지 부상의 여파가 컸던 만큼 구단은 여전히 신중한 태도를 유지하고 있고, 선발 복귀까지는 시간이 더 필요할 것으로 보여요.",
  },
  {
  ...
  },
  {
    ...
    status: "out",
    updated: "2026-08-28",
    headline: "기마랑이스, 사타구니 부상 '6주설'에 아르테타 감독이 직접 선 그어",
    summary:
      "아스널로 이적한 브루누 기마랑이스가 커뮤니티 실드 데뷔전 전반전을 마친 뒤 사타구니 통증으로 교체됐고, 프리시즌 준비 부족까지 겹치며 코번트리 시티와의 리그 개막전 명단에서도 제외됐어요. 이탈 기간이 최대 6주까지 갈 수 있다는 보도가 나오자 아르테타 감독은 '그 정도로 오래 걸릴 사안은 전혀 아니다'라며 직접 진화에 나섰어요.",
  },
  {
  ...
  },
  {
    ...
    status: "out",
    updated: "2026-08-28",
    headline: "리아드, 정밀 검진 결과 전방십자인대 파열 확정… 장기 결장 불가피",
    summary:
      "크리스탈 팰리스가 차디 리아드의 왼쪽 무릎 정밀 검진 결과 전방십자인대 파열로 확인됐다고 공식 발표했어요. 개막전이었던 에버턴 원정에서 제기됐던 부상 우려가 현실화되면서 리아드는 상당 기간 그라운드를 떠나게 됐고, 구단은 수비 로테이션 대비책 마련이 불가피해졌어요.",
  },
  {
  ...
  },
  {
    ...
    status: "doubtful",
    updated: "2026-08-28",
    headline: "오타니, 28일 디트로이트서 불펜 피칭… 9월 1일 선발 복귀 저울질",
    summary:
      "무릎 염증으로 등판하지 못했던 오타니가 8월 28일 디트로이트 원정에서 불펜 피칭을 소화하기로 했어요. 평소 불펜 피칭 이틀 뒤 실전에 등판해온 패턴을 감안하면, 결과가 좋을 경우 9월 1일 선발 등판으로 투수 복귀가 가능할 것으로 보여요.",
  },
  {
  ...
  },
  {
    ...
    status: "doubtful",
    updated: "2026-08-28",
    headline: "스미스, 재활 데뷔전서 홈런 포함 멀티히트… 9월 복귀 청신호",
    summary:
      "목(경추) 염증으로 이탈해 있던 다저스 포수 윌 스미스가 8월 25일 트리플A 오클라호마시티에서 재활 경기에 데뷔해 3타수 1안타(홈런)로 순조로운 출발을 보였어요. 실전 감각을 점검하는 재활 경기가 좋은 흐름으로 시작되면서, 로스터 확장이 시작되는 9월 초 활성화 전망에 힘이 실리고 있어요.",
  },
  {
  ...
  },
  {
    ...
    status: "doubtful",
    updated: "2026-08-28",
    headline: "뇬토, 팀 훈련 복귀… 브렌트포드전 앞두고 회복세",
    summary:
      "햄스트링 부상으로 개막전을 결장했던 윌리 뇬토가 팀 전체 훈련에 다시 합류했어요. 다니엘 파르케 감독은 그루예프, 구드문손과 함께 뇬토의 회복 상황도 긍정적으로 평가하며, 브렌트포드전을 앞두고 몸 상태를 지켜본 뒤 출전 여부를 결정할 방침이에요.",
  },
  {
  ...
  {
    id: "mlb-yankees-schmidt-elbow",
    photoQuery: "Clarke Schmidt",
    teamEn: "New York Yankees",
    league: "mlb",
    leagueLabel: "MLB",
    team: "뉴욕 양키스",
    ...
    status: "doubtful",
    updated: "2026-08-28",
    headline: "슈미트, 라이브 배팅 훈련 순항… 이번 주말 마이너 재활 등판 전망",
    summary:
      "토미존 수술 재활 중인 클라크 슈미트가 화요일 타자를 상대로 20구 라이브 배팅 훈련을 소화했고, 구속은 시속 95마일 안팎까지 나왔어요. 이르면 이번 주말 마이너리그 재활 등판에 나설 것으로 보이며, 순조롭게 진행되면 다음 달 불펜 요원으로 팀에 합류하는 것이 목표예요.",
  },
  {
    id: "mlb-reds-steer-wrist",
    photoQuery: "Spencer Steer",
    teamEn: "Cincinnati Reds",
    league: "mlb",
    leagueLabel: "MLB",
    team: "신시내티 레즈",
    player: "스펜서 스티어",
    status: "out",
    updated: "2026-08-28",
    headline: "스티어, 손목 힘줄집 부분 파열로 사실상 시즌 아웃",
    summary:
      "신시내티 스펜서 스티어가 7월 26일 카디널스전에서 파울 타구를 치다 오른쪽 손목에 통증을 느껴 10일 부상자 명단에 올랐어요. 손목 힘줄을 감싸는 힘줄집이 부분적으로 파열된 것으로 확인됐고, 수술 없이 자연 치유를 지켜보기로 하면서 본인도 '사실상 시즌은 끝났다'고 인정했어요. 다행히 내년 스프링캠프 전까지는 정상 컨디션을 되찾을 것으로 예상돼요.",
  },
  {
    ...
    status: "out",
    updated: "2026-08-28",
    headline: "크루스, 팔꿈치 인대 부분 파열 진단… 토미존 수술 가능성",
    summary:
      "팔꿈치 불편감으로 15일 부상자 명단에 올랐던 페르난도 크루스가 정밀 검진 결과 팔꿈치 인대(UCL) 부분 파열로 확인됐어요. 에런 분 감독은 수술이 현실적인 선택지 중 하나라고 밝혔고, 크루스는 치료 방향을 정하기 전 다른 병원에서 추가 소견을 받을 예정이에요.",
  },
  {
  ...
  {
    id: "mlb-reds-ashcraft-elbow",
    photoQuery: "Graham Ashcraft",
    teamEn: "Cincinnati Reds",
    league: "mlb",
    leagueLabel: "MLB",
    team: "신시내티 레즈",
  ...
  {
    id: "mlb-redsox-rutschman-elbow",
    photoQuery: "Adley Rutschman",
    teamEn: "Boston Red Sox",
    league: "mlb",
    leagueLabel: "MLB",
    team: "보스턴 레드삭스",
    ...
    status: "questionable",
    updated: "2026-08-28",
    headline: "러치먼, 스윙 도중 팔꿈치 과신전… 마이애미전 이틀 연속 결장",
    summary:
      "트레이드로 보스턴 유니폼을 입은 애들리 러치먼이 월요일 스윙 도중 오른쪽 팔꿈치가 과신전되며 통증을 느껴 마이애미전에 이틀 연속 결장했어요. 구단은 심각한 부상은 아니라는 입장이며, 휴식일을 거친 뒤 이어지는 양키스 원정 시리즈에는 정상 출전할 수 있을 것으로 기대하고 있어요.",
  },
  {
  ...
  {
    id: "epl-fulham-defougerolles-injury",
    photoQuery: "Luc de Fougerolles",
    teamEn: "Fulham",
    league: "epl",
    leagueLabel: "EPL",
    team: "풀럼",
    ...
    status: "questionable",
    updated: "2026-08-28",
    headline: "풀럼 유망주 드 푸제롤, 1군 데뷔전서 부상으로 조기 교체",
    summary:
  ...
  {
    id: "epl-chelsea-caicedo-palestra",
    photoQuery: "Moises Caicedo",
    teamEn: "Chelsea",
    league: "epl",
    leagueLabel: "EPL",
    team: "첼시",
    player: "모이세스 카이세도 · 마르코 팔레스트라",
    status: "doubtful",
    updated: "2026-08-29",
    headline: "첼시, 카이세도·팔레스트라 훈련 중 이상 증세로 풀럼전 결장",
    summary:
      "사비 알론소 감독이 훈련 중 이상을 느낀 모이세스 카이세도와 여름 영입생 마르코 팔레스트라를 무리하게 기용하지 않고 풀럼전 명단에서 제외했다고 밝혔어요. 카이세도의 증상은 비교적 가벼운 것으로 알려져 이번 주말 브라이튼전 복귀 가능성이 남아 있어요.",
  },
];
